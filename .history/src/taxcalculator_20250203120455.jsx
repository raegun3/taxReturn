...
const TaxCalculator = () => {
  ...
  const calculateTax = (e) => {
    ...
    return ( 
        <>
        <div className="z-0 col-lg-3 text-center bg-secondary" style={{height: '50px', width: 'auto'}}></div>
        <div className="z-0 bg-info">
            <div style={{display:'absolute', paddingTop:'-50px'}}className="container rounded bg-light z-1">
                <div id="head-box">
