                ...
                <div class="row text-center  g-2" >
                    ...
                    <div class="col-md">
                        <div class="card">
                            <div class="card-body p-0">
                                <i><span><TbTax/></span></i>
                                <p class="card-text mb-3 pb-md-4 pb-xl-0 pb-xxl-4">JavaScript (/ˈdʒɑːvəskrɪpt/), often abbreviated as JS, is a programming language and core technology of the Web, alongside HTML and CSS. </p>
                                <a href="#" class="btn w-50 btn-primary">Read more</a>
                            </div>
                        </div>
                    </div>
