...
const ContactMe = () => {
    return (
                    ...
                    <section className="contactUs">
                        <div className="container-fuild d-flex bg-light ">
                            <div className="py-5 row flex-column align-items-center justify-content-center">
                                ...
                                <div className="col-lg-5 map pt-3">
