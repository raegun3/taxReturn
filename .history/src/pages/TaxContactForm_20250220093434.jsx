    ...
    <div className="col-lg-4 w-lg-75 py-4 my-3 bg-warning rounded">
        <form method="post" id="contact-form">
            <div className=" w-sm-100 form-group row justify-content-center">                             
                    ...
                    <div className="col-sm-5 w-75 pt-1">
                    ...
                    <div className="col-sm-5 w-75 pt-1 align-items-between">
                        <div className="">
                            <input type="checkbox" name="consent" id="consent" className="" defaultChecked={true} required />    
                            <span className="padding-5"> I provide consent and authorize My Tax Refund Today (ABN 0000000000 and Tax Agent 000000000) to add me as a client in the Tax Agent Portal.</span>
                        </div>
                    </div>
                    <div className="col-sm-5 w-50 text-center pt-1">
