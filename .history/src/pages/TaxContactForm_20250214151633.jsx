        ...
        <form method="post" id="contact-form">
            <div className=" w-sm-100 form-group row justify-content-center ">                             
                    ...
                    <div className="col-sm-10 w-75">
                        ...
                        <input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required wpcf7-not-valid" aria-required="true" aria-invalid="true" placeholder="Date of Birth (DD/MM/YYYY)" value="" type="text" name="your-dob" />
                    </div>
