            ...
            <section className=" text-dark pt-3 pb-2 text-center d-flex flex-column">
                ...
                <div className="container bg-info h-50 d-flex">
                    <div className="row justify-content-evenly">
                        ...
                        <div className="col-lg-4 bg-light m-3 ps-1 text-start text-light">
                            <div className="row flex-column  bg-warning">
                                <div className="col">
                                ...
                                <div className="col">
                                    ...
                                    <div id="dropdow-list1" style={styleAttr} className="">
                                        <ul>
                                            <li style="color: white;">Invoice generation and management (high volume)</li>
                                            <li style="color: white;">PayPal account management and reconciliation</li>
                                            <li style="color: white;">Establish payroll (set-up)</li>
                                            <li style="color: white;">Process payroll, STP, and superannuation processing</li>
                                            <li style="color: white;">Monthly Instalment Activity Statement lodgement</li>
                                            <li style="color: white;">Additional customised reporting</li>
                                            <li style="color: white;">Additional online meetings</li>
                                            <li style="color: white;">Customised or anything extra – just ask us!</li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="col text-center">
