        ...
        <div>
            <div className="container rounded bg-dark text-light">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <label htmlFor="totalIncome" className="col-form-label">Gross payment or total income:</label>
                    <input name="totalIncome" type="number" autocomplete="off" autofocus className="form-control" required/>
                  </div>
                  <div class="co">
                    <label htmlFor="taxWithheld" className="col-form-label">Total tax withheld:</label>
                    <input name="taxWithheld" type="number" autocomplete="off" className="form-control" required/>
                  </div>
                  <div class="col">
                    <label htmlFor="deductions" className="col-form-label">Total deductions:</label>
                    <input name="deductions" type="text" autocomplete="off" className="form-control"/>
                  </div>
                  <div class="col pt-4">
                    <button className="btn btn-primary" onClick={ () => {handleClick}} type="submit" >Calculate tax return</button>
                  </div>
                  </form>
                </div>
              </div>
