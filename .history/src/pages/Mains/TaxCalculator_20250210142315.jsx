...
const TaxCalculator = () => {
  ...
  const handleChange = (e) => {
    ...
    console.log("form submitted:", totalIncome, taxWithheld, deductions );
  };
        ...
        <div>
            <div className="container rounded bg-dark text-light">
                ...
                <div class="row">                  
                  ...
                  <div class="col pt-4">
                    <button className="btn btn-primary" onClick={ () => {handleSubmit}}  onChange={handleChange} type="submit" >Calculate tax return</button>
                  </div>
                </div>
              </div>
