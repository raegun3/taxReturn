        ...
        <div>
            <div className="container rounded bg-dark text-light">
                ...
                <div class="row">
                  <form action="">
                  <div class="col">
                    <label for="totalIncome" className="col-form-label">Gross payment or total income:</label>
                    <input name="totalIncome" type="number" autocomplete="off" autofocus className="form-control" required/>
                  </div>
                  <div class="co">
                    <label for="taxWithheld" className="col-form-label">Total tax withheld:</label>
