                        ...
                        <div className="col-lg-4 pb-2 bg-warning rounded">
                            <form method="post" id="contact-form">
                                <div className=" w-sm-100 form-group row justify-content-center ">                             
                                        ...
                                        <div className="col-sm-10 w-75">
                                            <input placeholder="Tax File No." minLength="9" maxLength="9" name="tfn" id="tfn" type="number" autoComplete="off" className="form-control"/>
                                        </div>
                                        ...
                                        <div className="col-sm-10 w-50 text-center">
                                            <input className="btn btn-primary w-75" id="button"value="Send Email" type="submit" />
                                        </div>    
                                </div>             
                            </form>
                        </div>
