...
return ( 
    <>
        ...
        <div className="container row w-100 text-center">
            <div className="col-lg-4">
                <img className="w-50" src="./src/assets/calculator-icon.svg"></img>
            </div>
            <div className="col-lg-6">
                <div>
                    Why Lodge Your Tax Return With Us?
                </div>
                <h3>Below are a few of the compelling reasons why you should consider using our tax agents to prepare your tax return:</h3>
                <ul>
                    <li>
