                    ...
                    <div className="col-md">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="d-block">
                                <p className="card-text py-3">Cascading Style Sheets (CSS) is a style sheet language used for specifying the presentation and styling of a document written in a markup language such as HTML or XML </p>
                                <a href="#" className="btn w-50 btn-primary">Read more</a>
                                </div>
