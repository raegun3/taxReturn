                    ...
                    <div className="col-md">
                        <div className="card">    
                            <div className="card-body">
                                ...
                                <p className="card-text py-3 mb-1">HyperText Markup Language (HTML) is the standard markup language for documents designed to be displayed in a web browser.</p>
