                ...
                <div className="d-flex justify-content-center">
                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-lg-8">
                            <h1 className="text-light">Introduction of <span className="text-warning"> IT personnel</span></h1>
                            <p className="text-light lead my-4">I have taken CS50x course online from Harvard University.
