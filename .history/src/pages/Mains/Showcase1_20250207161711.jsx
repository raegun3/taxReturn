...
function Showcase1() {
    return (
            ...
            <section className="bg-dark text-dark p-5 text-center text-md-start">
                <div className="container">
                    <div className="d-sm-flex align-items-center justify-content:space-between">
                        ...
                        <div style={{minWidth:"400px"}} className="w-75 m-2 bg-warning rounded flex-grow-0">
                            <form action="/register" method="post">
                                <div style={{minWidth:"400px"}} class=" w-sm-100 form-group row justify-content-center ">                             
