        ...
        <div>
            <div className="container rounded bg-dark text-light">
                ...
                <div class="row text-dark">
                  <div class="col">
                    <label for="total_income" className="col-form-label text-start">Gross payment or total income:</label>
                    <input name="total_income" type="number" autocomplete="off" autofocus className="form-control w-50"/>
                  </div>
