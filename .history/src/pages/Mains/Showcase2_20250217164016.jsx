        ...
        <div className="container">
            <div className="row justify-content-between align-items-center">
                ...
                <div className="col-lg-7 text-start">
                    ...
                    <h5>Below are a few of the compelling reasons why you should consider using our tax agents to prepare your tax return:</h5>
                    <ul>
                        <li>
                            <h5>Trusted by more than 58,000 clients.</h5>
                        </li>
                        <li>
                            <h5>Average Google rating of 4.7 with over 1,000 reviews.</h5>
                        </li>
                        <li>
                            <h5>Certified CPA practice</h5>
                        </li>
                        <li>
                            <h5>Free tax refund estimate before working with you</h5>
                        </li>
                        <li>
                            <h5>Specialists with over 30 years’ combined experience to maximise your refund.</h5>
                        </li>
                        <li>
                            <h5>Instant tax refund and $0 upfront options</h5>
                        </li>
                        <li>
                            <h5>Easy online process.</h5>
                        </li>
