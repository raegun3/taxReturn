    ...
    return (
                    ...
                    <section className="contactUs">
                        <div className="container bg-light">
                            ...
                            <ContactForm /> 
                                <div className="col-lg-7 pt-5 order-lg-1">
