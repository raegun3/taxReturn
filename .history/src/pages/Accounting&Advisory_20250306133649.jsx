            ...
            <section className=" text-dark pt-3 pb-2 text-center d-flex flex-column">
                ...
                <div className="container h-50 d-flex">
                    <div className="row justify-content-evenly">
                        <div className="col-lg-4 m-3 ps-1 text-start text-light bg-info rounded">
                        ...
                        <div className="col-lg-4 m-3 ps-1 text-start text-light bg-warning rounded">
                            <div className="row flex-column">
                                <div className="col">
                                ...
                                <div className="col text-center">
                                    <Link to="AccountingAdvisory"><button className="btn justify-content-center btn-primary w-100">Get Started</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
