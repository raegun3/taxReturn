...
function ContactForm() {
    ...
    <div className="col-6 col-lg-4 p-4 my-3 bg-warning rounded">
        <form method="post" id="contact-form">
            <div className=" form-group row justify-content-center py-5">                             
                    ...
                    <div className=" pt-1">
                        <input placeholder="Tax File No." min="9" max="9" name="tfn" id="tfn" type="number" autoComplete="off" className="form-control" required />
                    </div>
