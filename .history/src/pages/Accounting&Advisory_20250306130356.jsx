            ...
            <section className=" text-dark pt-3 pb-2 text-center d-flex flex-column">
                ...
                <div className="container bg-info h-50 d-flex">
                    <div className="row justify-content-evenly">
                        <div className="col-lg-4 bg-light m-3 ps-1 text-start">
                            <div className="row flex-column">
                                ...
                                <div className="col">
                                    ...
                                    <ul className="" >
                                            ...
                                            <li className="">Another action</li>
                                            <li className="">Something else here</li>
                                            <li className=""></li>
                                            <li className="">Separated link</li>
                                    </ul>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 bg-light m-3 ps-1 text-start">
                            <div className="row flex-column">
                                ...
                                <div className="col">
                                    <h1 className="fw-bolder">$250.00/month + GST</h1>
                                </div>
                                <div className="col">
                                <ul>
                                    <li>Unlimited support by telephone and email</li>
                                ...
                                <div className="col">
                                    ...
                                    <div id="dropdow-list1" style={styleAttr} className="">
                                    <ul>
                                        <li style="color: white;">Unlimited support by telephone and email</li>
                                        <li style="color: white;">Preparation of quarterly or monthly BAS</li>
                                        <li style="color: white;">Preparation of year-end working papers, reconciling balance sheet items</li>
                                        <li style="color: white;">Monthly bank and credit card reconciliations</li>
                                        <li style="color: white;">Quarterly financial statements and management reports prepared by a CPA</li>
                                        <li style="color: white;">Enter and match customer receipts monthly – debtors reconciliation</li>
                                        <li style="color: white;">Enter and match supplier payments monthly – creditor reconciliation</li>
                                        <li style="color: white;">Quarterly 30-minute online meeting</li>
                                    </ul>
                                    </div>
                                </div>
                                <div className="col text-center">
