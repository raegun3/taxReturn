                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-lg-8">
                                    ...
                                    <div className=" container text-start text-light rounded">
                                        <ul className="tick-style large-gap no-mar-bot">
                    ...
                    <div className="row justify-content-evenly">
                        <div className="col-lg-5 bg-light m-3 ps-1">
                            <div className="row flex-column">
                                ...
                                <div className="col">
                                    <button className="btn" type="button" onclick="handleClick" id="dropdownMenuButton2">
                                        Add-ons
                                    </button>
                                    <div>
                                    <ul className="dropdown-menu" style={{display: "none"}}>
                                            <li className="dropdown-item active">Action</li>
