                    ...
                    <div className="ml">
                        <form action="/register" method="post">
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-10 w-75">
                                    <input type="checkbox" name="consent" class="form-control" defaultChecked={true}/>
                                    <p1>I provide consent and authorize My Tax Refund Today (ABN 0000000000 and Tax Agent 000000000) to add me as a client in the Tax Agent Portal.</p1>
                                </div>
