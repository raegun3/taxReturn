...
const TaxCalculator = () => {
  ...
  const calculateTax = (e) => {
    ...
    return ( 
        <div className="bg-info z-1">
            <div className="z-1 bg-dark w-100 h-25"></div>
            <div style={{paddingTop: '-50px'}} className="container justify-content-center rounded bg-light z-1">
                <div id="head-box">
