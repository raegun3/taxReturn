...
function Navbar() {
      ...
      // Here we have an array of items that can be used to render <> elements.
      const lists = [
        '<Link to="OnSpotTaxReturn" className="dropdown-item">Tax Return 2025</Link>',
        '<Link to="FeesAndCharges" className="dropdown-item" >Fees & Charges</Link>',
        '<a className="dropdown-item" href="#">Something else here</a>',
      ];
      console.log(lists);
      const listItems = lists.map( list, index => <li key={list.index}>{list.list}</li>);
